...
![브라우저 작업 도구 고정](./.source/chrome_app/hold_set.png)
...
일반[General] 탭에 위치한 파일 관리[File Handling] 설정 변경 -> 모두 체크 해제

스냅샷, 논문 pdf 파일 다운로드를 하는 경우 무료 사용 용량이 쉽게 차버림.

논문에 대한 메모의 경우 용량이 무제한이나, 스냅샷, 논문 PDF은 용량을 요구함.

### 3.3 [데스크탑 앱] 기본 언어 설정 (선택)

일반[General] 탭에 위치한 일반[General] 항목의 언어 설정 변경 -> English 추천
