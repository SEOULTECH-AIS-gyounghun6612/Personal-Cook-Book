# Zotero 가이드 (Zotero Guide)

연구 자료(논문)의 효율적인 관리 및 협업을 위한 Zotero 가이드입니다.

본 가이드는 Zotero의 설치부터 구조적 이해, 실전 활용까지 단계별로 구성되어 있습니다.

## 목차 (Table of Contents)

### 1. [설치 및 초기 설정 (Installation)](./01_install.md)
